 ...
 */
public class CacheEntryEventFilteringIterator<K, V> implements Iterator<CacheEntryEvent<K, V>> {
  ...
  /**
   * Constructs an {@link CacheEntryEventFilteringIterator}.
   *
   * @param iterator the underlying iterator to filter
   * @param filter   the filter to apply to entries in the iterator
   */
  public CacheEntryEventFilteringIterator(Iterator<CacheEntryEvent<K, V>> iterator,
